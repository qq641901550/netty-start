 ...
 * 
 */
@WebServiceClient(name = "WebService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:10004/WebService/?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:10004/WebService/?wsdl");
     ...
     *     returns IWebService
     */
    @WebEndpoint(name = "BasicHttpBinding_IWebService")
    public IWebService getBasicHttpBindingIWebService() {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_IWebService"), IWebService.class);
    }
     ...
     */
    @WebEndpoint(name = "BasicHttpBinding_IWebService")
    public IWebService getBasicHttpBindingIWebService(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_IWebService"), IWebService.class, features);
    }
